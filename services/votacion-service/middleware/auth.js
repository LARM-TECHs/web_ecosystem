// votacion-service/middleware/auth.js
...
export const authenticateService = (req, res, next) => {
    ...
    if (!userId || !userCorreo || !userRol) {
        ...
        console.warn('Authentication Warning: Request to votacion-service missing expected user headers from API Gateway.');
...
export const authorizeRoles = (allowedRoles) => {
    return (req, res, next) => {
        ...
        if (!req.user || !req.user.rol) {
            ...
            console.warn('Authorization Warning: User information (role) not available for authorization check.');
