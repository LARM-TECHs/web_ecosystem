import {
  ...
  function ChatNew() {
    ...
    const backToHistoryPrompt = async (uniqueTitle) => {
      ...
      setText('');
      try {
        const response = await getChatHistory(uniqueTitle);
        setPreviousChats(response.history);
      } catch (error) {
    ...
    const submitHandler = async (e) => {
      ...
      try {
        ...
        setPreviousChats((prevChats) => [...prevChats, { text, sender: 'user' }, botMessage]);
        setLocalChats((prevChats) => [...prevChats, { text, sender: 'user' }, botMessage]);
        setText('');
        setTimeout(() => {
