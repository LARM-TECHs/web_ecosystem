...
const Brigadas = () => {
  ...
  useEffect(() => {
    // Obtener brigadas según la carrera seleccionada
  ...
  const eliminarBrigada = async (id) => {
    await axios.delete(`http://localhost:3000/auth/brigadas/${id} `);
    setBrigadas(brigadas.filter((brig) => brig.id_brigada !== id));
  };
    ...
    <>
      ...
      <div className="container">
        ...
        <table className="table caption-top">
          <caption>Lista de brigadas</caption>
          <thead>
            <tr>
          ...
          <tbody className="table-group-divider">
            {brigadas.map((b) => (
              <tr key={b.id_brigada}>
                <td>{b.nombre_brigada}</td>
                <td>{b.año_brigada}</td>
                <td>{b.añofinal_brigada}</td>
                <td className="d-flex justify-content-end">
                  <button
                    type="button"
                    className="btn mr-5"
                    onClick={() =>
                      navigate(`/home/brigadas/${b.id_brigada}/editar`)
                    }
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <button
                    type="button"
                    className="btn"
                    onClick={() => eliminarBrigada(b.id_brigada)}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
